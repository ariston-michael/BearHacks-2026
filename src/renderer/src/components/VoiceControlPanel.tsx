  ...
  return (
    <section className="rounded-xl border border-white/10 bg-white/5 p-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-white">Voice Control (ElevenLabs Scribe)</h2>
          <p className="mt-1 text-sm text-white/60">
            Energy-VAD + ElevenLabs Scribe. Speak a phrase, pause, and the transcript appears with
            speaker labels.
          </p>
        </div>
        {_isRecording && (
      ...
      <div className="mt-4 flex gap-2">
        <button
          ...
          disabled={!_hasApiKey || _isListening}
        >
